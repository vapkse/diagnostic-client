...
export class SliderComponent {
    ...
    public set items(items: QueryList<ElementRef<HTMLDivElement>>) {
        this._items = items;
        this.refresh$.next();
    }

    public get items(): QueryList<ElementRef<HTMLDivElement>> {
        return this._items;
    }

    @ViewChild('slides')
    public set slidesContainer(slider: ElementRef<HTMLDivElement>) {
        this._slider = slider;
        this.refresh$.next();
    }

    public get slidesContainer(): ElementRef<HTMLDivElement> {
        return this._slider;
    }

    public get currentItem(): ElementRef<HTMLDivElement> {
